      ...
      `}>
        ...
        <div className="mt-auto pt-4 flex flex-col gap-3 w-full px-3 md:px-6 mb-2 border-t border-white/5 md:hidden">
          <a
            ...
            className="w-full aspect-square rounded-lg glass flex items-center justify-center text-indigo-400 border border-indigo-500/20 hover:border-indigo-400 hover:shadow-[0_0_15px_rgba(99,102,241,0.3)] transition-all group scale-90"
          >
          ...
          <a
            ...
            className="w-full aspect-square rounded-lg glass flex items-center justify-center text-amber-500 border border-amber-500/20 hover:border-amber-500/50 hover:shadow-[0_0_15px_rgba(245,158,11,0.3)] transition-all group scale-90"
          >
