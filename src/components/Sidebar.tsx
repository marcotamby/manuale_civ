  ...
  return (
    <>
      ...
      `}>
        ...
        {currentPage !== 'home' && (
          <div className="flex flex-col gap-4 mb-8 shrink-0 w-full px-2 md:px-4">
            <button
        ...
        {currentPage !== 'home' && <div className="w-10 h-[1px] bg-[#D4AF37]/20 mb-6 shrink-0" />}
        ...
        <div className="mt-auto pt-6 flex flex-col gap-4 w-full px-2 md:px-4 mb-4 border-t border-white/5">
          <a
            href="https://discord.gg/XmFhYzwC"
            target="_blank"
            rel="noopener noreferrer"
            title="Unisci al Discord di Aoeitalia"
            className="w-full aspect-square rounded-xl glass flex items-center justify-center text-indigo-400 border border-indigo-500/20 hover:border-indigo-400 hover:shadow-[0_0_15px_rgba(99,102,241,0.3)] transition-all group"
          >
          ...
          <a
            ...
            className="w-full aspect-square rounded-xl glass flex items-center justify-center text-amber-500 border border-amber-500/20 hover:border-amber-500/50 hover:shadow-[0_0_15px_rgba(245,158,11,0.3)] transition-all group"
          >
