        ...
        <div className="flex flex-col w-full mb-6">
          {favoriteCivs.map((civ) => (
            ...
            >
              ...
              />
              {/* Left edge fade - more pronounced */}
              <div className="absolute inset-y-0 left-0 w-8 bg-gradient-to-r from-[var(--color-brand-dark)] via-[var(--color-brand-dark)]/40 to-transparent pointer-events-none z-10" />
