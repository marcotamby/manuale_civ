...
export function Topbar({ onOpenAdminDashboard, onOpenAdminOverlay }: TopbarProps) {
  ...
  return (
    <div className="w-full bg-gradient-to-r from-[#0d1424] via-[#1a1c32] to-[#0d1424] border-b border-yellow-500/20 flex flex-col lg:flex-row items-center justify-between px-4 py-4 lg:pl-14 lg:pr-[73px] lg:py-5 z-[100] shrink-0 gap-4 shadow-[0_4px_20px_rgba(0,0,0,0.5)] relative">
      ...
      <div className="flex flex-wrap lg:flex-1 items-center justify-center lg:justify-start gap-2 xl:gap-3 order-2 lg:order-1 max-w-md">
        <a
      ...
      <Link 
        to="/" 
        className="flex flex-col items-center justify-center text-center w-full lg:flex-1 order-1 lg:order-2 group cursor-pointer hover:opacity-95 transition-all py-1"
      >
      ...
      {/* Auth / Right side */}
      <div className="flex lg:flex-1 items-center justify-center lg:justify-end order-3">
        {isAuthenticated ? (
