...
export function Topbar({ onOpenAdminDashboard, onOpenAdminOverlay, isHome }: TopbarProps) {
  ...
  return (
    <div className="w-full flex flex-col shrink-0 z-[100] relative select-none">
      ...
      <div className={`w-full ${isSpecialPage ? 'lg:bg-transparent lg:border-b-0 lg:shadow-none' : 'bg-[#000000]/80 backdrop-blur-md border-b border-yellow-500/20 shadow-[0_4px_20px_rgba(0,0,0,0.5)]'} ${!isHome ? 'hidden md:flex' : 'flex'} flex-col items-center px-4 py-3 md:px-14 md:py-4 lg:px-20 lg:pt-6 lg:pb-0 z-[100] shrink-0 gap-3 md:gap-4 relative`}>
          ...
          {isAuthenticated ? (
            <>
              ...
              <div className="flex items-center gap-2">
                ...
                <div className="h-10 px-3 bg-[#0d1424] rounded-xl border border-yellow-500/30 flex items-center gap-2 shadow-lg">
