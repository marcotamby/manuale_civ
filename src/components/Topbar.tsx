...
export function Topbar({ onOpenAdminDashboard, onOpenAdminOverlay }: TopbarProps) {
  ...
  return (
    <div className="w-full bg-gradient-to-r from-[#0d1424] via-[#1a1c32] to-[#0d1424] border-b border-yellow-500/20 flex flex-col md:flex-row items-center justify-between px-4 py-4 md:pl-14 md:pr-[73px] md:py-5 z-[100] shrink-0 gap-4 shadow-[0_4px_20px_rgba(0,0,0,0.5)] relative overflow-hidden">
      ...
      <div className="absolute bottom-0 left-0 right-0 h-12 pointer-events-none opacity-30 select-none z-0 flex items-end overflow-hidden">
        <svg width="100%" height="32" viewBox="0 0 1200 32" preserveAspectRatio="none" xmlns="http://www.w3.org/2000/svg" className="w-full">
          <path 
            ...
            strokeWidth="1" 
          />
          <path d="M50,18 L50,12 M200,18 L200,8 M400,18 L400,10 M650,18 L650,12 M850,18 L850,8 M1100,18 L1100,10" stroke="white" strokeWidth="1" />
        </svg>
      </div>
