...
const MAPS_DATA: MapInfo[] = [
  ...
  { name: "Danube Divide", category: "Ibrida", url: "https://liquipedia.net/ageofempires/Danube_Divide" },
  ...
  { name: "Kerlaugar", category: "Ibrida", url: "https://liquipedia.net/ageofempires/Kerlaugar" },
  ...
  { name: "Silk Road", category: "Terrestre", url: "https://liquipedia.net/ageofempires/Silk_Road" },
