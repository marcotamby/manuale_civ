  ...
  return (
    <footer className="hidden md:flex items-center justify-between px-8 py-4 border-t border-white/10 bg-[#16171d] z-50">
      <div className="flex items-center gap-4 lg:gap-8 flex-nowrap shrink-0">
        ...
        <div className="flex items-center gap-3 lg:gap-8 flex-nowrap">
          <a 
          ...
          >
            ...
            <span>Discord <span className="text-white/20 font-medium">Aoeitalia</span></span>
          </a>
        </div>
      </div>

      <div className="flex items-center gap-3 lg:gap-6 text-[10px] lg:text-[12px] font-bold text-white/30 uppercase tracking-widest whitespace-nowrap shrink-0">
