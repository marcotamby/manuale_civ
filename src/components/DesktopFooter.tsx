  ...
  return (
    <footer className="hidden md:flex items-center justify-between px-8 py-4 border-t border-white/10 bg-[#16171d] z-50">
      <div className="flex items-center gap-4 lg:gap-8 flex-nowrap shrink-0">
        ...
        <div className="flex items-center gap-2 lg:gap-4 xl:gap-8 flex-nowrap">
          <a 
          ...
          >
            ...
            <span>YouTube <span className="hidden 2xl:inline text-white/20 font-medium">Aoeitalia</span></span>
          </a>
          ...
          >
            <Youtube size={16} className="group-hover:scale-110 transition-transform" />
            <span>YouTube <span className="hidden 2xl:inline text-white/20 font-medium">marcotamby</span></span>
          </a>
