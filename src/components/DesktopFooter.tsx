  ...
  return (
    <footer className="hidden md:flex items-center justify-between px-8 py-4 border-t border-white/10 bg-[#16171d] z-50">
      <div className="flex items-center gap-8">
        <p className="text-[10px] font-black text-cyan-400 uppercase tracking-[0.2em] select-none">
          Social & Community
        </p>
        ...
        <div className="flex items-center gap-8">
          <a 
            ...
            className="flex items-center gap-2 text-[11px] font-bold text-white/70 hover:text-purple-400 transition-all group"
          >
            <Twitch size={14} className="group-hover:scale-110 transition-transform" />
          ...
          <a 
            ...
            target="_blank" 
            rel="noopener noreferrer"
            className="flex items-center gap-2 text-[11px] font-bold text-white/70 hover:text-red-500 transition-all group"
          >
