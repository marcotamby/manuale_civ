    ...
    >
      ...
      { (isHome || isTournaments || isFaq || isCiv) && (
        <div 
          ...
          style={{ 
            backgroundImage: `
              linear-gradient(to bottom, transparent 0%, ${isCiv ? 'transparent 10%, #0a0a0b 40%' : 'transparent 40%, #0a0a0b 100%'}),
            ...
            maskImage: `linear-gradient(to bottom, black ${isCiv ? '25%' : '85%'}, transparent 100%)`,
            WebkitMaskImage: `linear-gradient(to bottom, black ${isCiv ? '25%' : '85%'}, transparent 100%)`
          }}
        ></div>
      )}
