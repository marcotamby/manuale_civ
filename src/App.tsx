    ...
    >
      ...
      { (isHome || isTournaments || isFaq || isCiv) && (
        <div 
          ...
          style={{ 
            backgroundImage: `
              linear-gradient(to bottom, transparent 0%, ${isCiv ? 'transparent 5%, #0a0a0b 30%' : 'transparent 40%, #0a0a0b 100%'}),
            ...
            maskImage: `linear-gradient(to bottom, black ${isCiv ? '2%' : '85%'}, transparent ${isCiv ? '15%' : '100%'})`,
            WebkitMaskImage: `linear-gradient(to bottom, black ${isCiv ? '2%' : '85%'}, transparent ${isCiv ? '15%' : '100%'})`
          }}
        ></div>
      )}
